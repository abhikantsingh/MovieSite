  ...
  return (
    <div className="Search">
      <div className="main2">
        ...
        <button onClick={() => {handelChange(); dispatch(changeBool())}}>Return..</button>
      </div>
      <div className="filter">
        ...
        <div style={{textAlign:"center",margin:"10px"}}>Select the language of the movie you want to watch.......</div>
