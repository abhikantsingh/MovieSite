...
},
{
    ...
    return(
        ...
        <div className="midware">
            <img src={require("../../assets/images/lead-in-v3-collection-202102040828.avif")} alt="" />
        </div>
        ...
        <div className="Premier">
         <img src={require("../../assets/images/premiere-banner-web-collection-202208191200.avif")} alt="" />
        </div>
        <div  className="Main2">
